...
export default {
        ...
        tooltip:{
          ...
          formatter:function (para){
            ...
            for (let i = 0; i < para.length; i++) {
              ...
              }else if (para[i].seriesName === this.currentChartParam.currentLegend[0]){
                res += "pre-1： "+ para[i].data + " 对应洪水场次ID: "+this.currentChartParam.preFloodIds[0] +'<br>';
              }
              else if (para[i].seriesName === this.currentChartParam.currentLegend[1]){
                res += "pre-2： "+ para[i].data + "   对应洪水场次ID: "+this.currentChartParam.preFloodIds[1] +'<br>';
              }
              else if (para[i].seriesName === this.currentChartParam.currentLegend[2]){
                res += "pre-3： "+ para[i].data + "   对应洪水场次ID: "+this.currentChartParam.preFloodIds[2] +'<br>';
              }
            }
            return res
          }
  ...
  watch:{
    ...
    //     console.log("结果chart，sim3 ", newValue)
    //   },
    //   deep:true,
    //   immediate:true
    // }
